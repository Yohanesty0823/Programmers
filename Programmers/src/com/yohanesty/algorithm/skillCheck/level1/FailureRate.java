...
public class FailureRate {
	...
	public static void main(String[] args) {
		...
		int[] case1 = {2, 1, 2, 6, 2, 4, 3, 3};
		int[] answer1 = s.solution(case1.length, case1);
		System.out.println("### 길이 : " + answer1.length);
		System.out.println("### 결과 : " + Arrays.toString(answer1));
		
		int[] case2 = {4,4,4,4,4};
		int[] answer2 = s.solution(case2.length, case2);
...
class Solution2 {
	 ...
	 * [2, 1, 2, 6, 2, 4, 3, 3] [3,4,2,1,5] 4 [4,4,4,4,4] [4,1,2,3] 입출력 예 설명 입출력 예
	 * #1 1번 스테이지에는 총 8명의 사용자가 도전했으며, 이 중 1명의 사용자가 아직 클리어하지 못했다. 따라서 1번 스테이지의 실패율은
	 * 다음과 같다.
	 * 
